...
test("单条与全部笔记都走同一个飞书同步消息", async () => {
  ...
  assert.equal(ctx.larkSyncMessage({ success: true, synced: 2 }), "已同步 2 条笔记。");
});
