...
(() => {
  ...
  function styleButton(button, { floating }) {
    button.style.cssText = floating
      ? `${BUTTON_BASE}background:${DIGEST_BLUE};box-shadow:0 2px 8px rgba(0,86,190,.28);`
      : `${BUTTON_BASE}background:${DIGEST_BLUE};margin-left:12px;`;
  }
  ...
  function injectDigestButton() {
    ...
    button.title = "打开 Video Digest AI 侧边栏";
